...
declare function getEntityFromTypeName(service: any, typePossiblyWithPrefix: string): GraphEntity;
declare function constructGraphLinksFromServicePath(service: any): GraphNodeLink[];
