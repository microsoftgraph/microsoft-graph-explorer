...
},
{
    "category": "Security",
    "method": "GET",
    "humanName": "TI indicator by Id (beta)",
    "requestUrl": "/beta/security/tiIndicators/{id}",
    "docLink": "https://docs.microsoft.com/en-us/graph/api/tiindicator-get",
...
},
{
    "category": "Security",
    "method": "GET",
    "humanName": "security actions by Id (beta)",
    "requestUrl": "/beta/security/securityActions/{id}",
    "docLink": "https://docs.microsoft.com/en-us/graph/api/securityaction-get",
    "tip": "This query requires the security action id. To find the ID, you can run: GET https://graph.microsoft.com/beta/security/securityActions?$top=1",
    "skipTest": false
},
{
    "category": "Security",
